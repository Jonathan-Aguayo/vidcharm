...
-- AddForeignKey
ALTER TABLE `Video` ADD CONSTRAINT `Video_uId_fkey` FOREIGN KEY (`uId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Playlist` ADD CONSTRAINT `Playlist_uId_fkey` FOREIGN KEY (`uId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Channel` ADD CONSTRAINT `Channel_uId_fkey` FOREIGN KEY (`uId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
